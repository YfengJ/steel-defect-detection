...
```bash
python translate.py --img 640 --epochs 3 --data coco128.yaml --weights yolov5s.pt
```
...
python translate.py --img 640 --epochs 3 --data coco128.yaml --weights yolov5s.pt  # 3. train
```
